...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+EDr3uBdOEjYxMmE1')
TUTORIAL = environ.get('KMS UPDATES', 'https://t.me/kmsmovies1')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Vaazhu Vaazha Vidu ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ''))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'KMS_Support_Group)
